...
HD_PWD='/home/csgvinamra/FlowPix/GaussianBlur/Gaussian/Gaussian.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mkGaussBlur.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mkGaussBlur.tcl -notrace
